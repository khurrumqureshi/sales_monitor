...
var AnonymIdRejectedError = function (msg) {
    AnonymIdRejectedError.super_.call(this, msg, this.constructor)
}

util.inherits(AnonymIdRejectedError, AbstractError)
AnonymIdRejectedError.prototype.name = 'AnonymId Rejected';
AnonymIdRejectedError.prototype.code = 456;
...
InvalidArgumentError.prototype.code = 409;
...
module.exports = {
    ...
    AnonymIdRejected:AnonymIdRejectedError,
